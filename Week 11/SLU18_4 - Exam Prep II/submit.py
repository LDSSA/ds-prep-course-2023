...
# line 75/76 has to be changed for SLU 17 and 18 (exam prep)
...
#        lunit=int(re.findall('[0-9][0-9]',path_split[-1])[0]) #all other slus
        lunit=int(re.findall('[0-9][0-9]_[0-9]',path_split[-1])[0]) #SLU17 and 18 (exam prep)
